  ...
  readonly cv: CvData = {
    ...
    skills: [
      ...
      },
      {
        ...
        items: ['Event-Driven Architecture', 'Serverless', 'Microservices', 'Technical Mentoring', 'System Design', 'Forward Deployment'],
      },
    ],
    certifications: [
